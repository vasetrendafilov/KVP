...
START_HEIGHT = 800.0
START_SPEED = 30.0 #za pocnetna brzina da ne pade odma
...
class RocketLander(gym.Env):
    ...
    def reset(self):
        ...
        #self.lander.angularVelocity = (0.1 + INITIAL_RANDOM) * np.random.uniform(-1, 1)
    ...
    def step(self, action):
        ...
        reward = -fuelcost # tuka se stava na 0
        ...
        if self.stepnumber > self.maxstep:
            return np.array(state), -10, True, {}
